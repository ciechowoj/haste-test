...
void assert_almost_eq(void*, void*, int, int, call_site_t);
...
noinline void assert_almost_eq(T a, T b, call_site_t site = {}) {
...
#define unittest_9w3krm934b(ln, uq, ...)                                   \
  ...
  unused_hungff9q36 const int unittest_1oxgaer4ai(ln, uq##_t) =            \
